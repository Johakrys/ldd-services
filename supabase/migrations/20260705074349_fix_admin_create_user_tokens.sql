-- =====================================================================
--  LDD Services — Corrige admin_create_user
--
--  GoTrue no acepta NULL en sus columnas de tokens; deben ir como ''.
--  Sin esto, el login falla con "Database error querying schema".
-- =====================================================================
